...
val snacks = listOf(
    Snack(
        ...
        kind = "热门城市",
        keyword = "金陵, 建康, 江苏省, 长江下游, 东部战区, 历史文化名城, 科教中心, 长三角, 中西部门户"
    ),
    Snack(
        id = 2L,
        name = "无锡市",
        ...
        kind = "热门城市",
        keyword = "江南水乡, 太湖, 梁溪, 江苏省, 江阴, 宜兴, 无锡小笼包"
    ),
    Snack(
        id = 3L,
        name = "徐州市",
        ...
        kind = "热门城市",
        keyword = "云龙湖, 矿业城市, 戏马台, 邳州, 睢宁, 铜山区, 汉文化, 彭城, 淮海战役纪念馆, 贾汪区, 马陵山"
    ),
    Snack(
        id = 4L,
        name = "常州市",
        ...
        kind = "热门城市",
        keyword = "龙城, 天宁寺, 红梅公园, 常州恐龙园, 武进, 溧阳, 金坛, 滆湖"
    ),
    Snack(
        id = 5L,
        name = "苏州市",
        ...
        kind = "热门城市",
        keyword = "园林之城, 拙政园, 虎丘, 周庄古镇, 平江路, 观前街, 苏州博物馆, 金鸡湖, 太湖, 寒山寺, 昆曲"
    ),
    Snack(
        id = 6L,
        name = "南通市",
        ...
        kind = "热门城市",
        keyword = "江海交汇, 通州区, 狼山, 濠河, 南通博物苑, 中国近代第一城, 南通纺织"
    ),
    Snack(
        id = 7L,
        name = "连云港市",
        ...
        kind = "热门城市",
        keyword = "花果山, 孙悟空故里, 渔港, 海州湾, 连岛, 云龙山, 港口城市, 矿产资源, 新亚欧大陆桥, 东海水晶"
    ),
    Snack(
        id = 8L,
        name = "淮安市",
        ...
        kind = "热门城市",
        keyword = "周恩来故乡, 京杭大运河, 淮扬菜, 古淮河, 洪泽湖, 清江浦, 文通塔, 淮安府署, 吴承恩故居, 鱼米之乡"
    ),
    Snack(
        id = 9L,
        name = "盐城市",
        ...
        kind = "热门城市",
        keyword = "盐城港, 盐城盐业历史博物馆, 东台湿地, 大丰麋鹿国家级自然保护区, 响水湖, 盐城经济技术开发区, 盐城生态园区"
    ),
    Snack(
        id = 10L,
        name = "扬州市",
        ...
        kind = "热门城市",
        keyword = "扬州瘦西湖, 个园, 大明寺, 瘦西湖, 东关街, 何园, 文昌阁, 扬州市博物馆, 五亭桥"
    ),
    Snack(
        id = 11L,
        name = "镇江市",
        ...
        kind = "热门城市",
        keyword = "镇江市, 金山寺, 宝塔山, 南山风景区, 西津渡, 神策门, 镇江大桥, 瘦西湖, 八怪博物馆, 瓮城"
    ),
    Snack(
        id = 12L,
        name = "泰州市",
        ...
        kind = "热门城市",
        keyword = "太湖国家森林公园, 兴化市, 泰州博物馆, 花果山风景区, 扬州市, 高港区"
    ),
    Snack(
        id = 13L,
        name = "宿迁市",
        ...
        kind = "热门城市",
        keyword = "宿预, 下相, 水街古镇, 宿迁博物馆, 骆马湖风景区"
    ),
    Snack(
        id = 14L,
        name = "南京咸水鹅副本",
    ...
    Snack(
        ...
        kind = "知名小吃",
        keyword = "江苏特色美食, 镇江传统菜肴, 中华美食, 肉类佳肴"
    ),
    ...
    Snack(
        ...
        kind = "知名小吃",
        keyword = "中式糕点, 传统美食, 酥脆口感, 糕点文化, 精致制作"
    ),
    ...
    Snack(
        ...
        kind = "旅游景点",
        keyword = "扬州, 风景区, 亭台楼阁, 五亭桥, 二十四桥, 旅游胜地"
    ),
    Snack(
        id = 23L,
        name = "夫子庙",
    ...
    Snack(
        ...
        kind = "旅游景点",
        keyword = "水乡, 苏州, 古建筑, 小桥流水, 旅游胜地, 江南风情"
    ),
    ...
    Snack(
        ...
        kind = "旅游景点",
        keyword = "石板路, 水上人家, 古镇旅游, 小桥流水, 文化遗产, 乌篷船"
    ),
    ...
    Snack(
        ...
        kind = "旅游景点",
        keyword = "江南园林, 园林建筑, 古典美学, 小桥流水, 精巧设计, 名园荟萃"
    ),
    ...
    Snack(
        ...
        kind = "旅游景点",
        keyword = "大佛景区, 佛教文化, 佛像雕塑, 度假圣地, 祈福圣地, 灵山胜境"
    ),
    ...
    Snack(
        ...
        kind = "旅游景点",
        keyword = "古刹, 佛教寺院, 南京, 祈福, 梅花, 旅游景点, 历史文化"
    ),
    ...
    Snack(
        ...
        kind = "风俗习惯",
        keyword = "花灯, 元宵节, 南京, 传统节日, 文化盛会, 秦淮河, 游客, 民俗活动, 夜景"
    ),
    ...
    Snack(
        ...
        kind = "风俗习惯",
        keyword = "淮扬菜, 江鲜, 八道菜, 淮安, 新鲜, 美食, 特色菜肴, 传统美食, 鱼虾蟹"
    ),
    ...
    Snack(
        ...
        kind = "风俗习惯",
        keyword = "妈祖文化, 庙会活动, 信仰活动, 祈福, 祭祀, 传统节日, 文化庆典"
    ),
    Snack(
        id = 32L,
        name = "苏州轧神仙",
    ...
    Snack(
        ...
        kind = "风俗习惯",
        keyword = "琴书, 传统艺术, 戏曲, 文化遗产, 表演艺术, 江苏地方戏曲, 演出, 古老艺术"
    ),
    ...
    Snack(
        ...
        kind = "风俗习惯",
        keyword = "踏春, 春游, 登山, 景区, 江苏, 南京, 自然风光, 春天"
    ),
)
